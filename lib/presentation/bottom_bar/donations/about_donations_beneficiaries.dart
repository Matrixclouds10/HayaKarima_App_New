...
import '../../widgets/widget_donation_stats_beneficiaries.dart';
import '../../widgets/widget_donation_stats_project.dart';
import '../../../router/router_path.dart';
import 'package:hexcolor/hexcolor.dart';
import 'package:readmore/readmore.dart';

class Donations_AboutBeneficiaries extends StatelessWidget {
  late Data_Beneficiaries data_project;

  Donations_AboutBeneficiaries(this.data_project); // late var email, password;
    ...
    return Scaffold(
        ...
        body: SafeArea(
          ...
          children: <Widget>[
            ...
            Container(margin: EdgeInsets.only(bottom: 10.h, left: 10.w, right: 10.w, top: 0.h), child: Widget_Donation_Stats_Beneficiaries(data_project)),
            Container(
