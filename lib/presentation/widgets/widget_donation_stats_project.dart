    ...
    return Container(
      child: Container(
        decoration: BoxDecoration(
            color:
                HexColor(MyColors.white), //new Color.fromRGBO(255, 0, 0, 0.0),
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                ...
                Container(
                  alignment: Alignment.center,
                  margin: EdgeInsets.only(left: 1.w, right: 1.w, top: 10.h),
                  width: 40.w,
                  height: 40.h,
                  decoration: BoxDecoration(
                      shape: BoxShape.circle, color: HexColor(MyColors.green)),
                  child: Text(
            ...
            Container(
                ...
                child: Row(
                    ...
                    children: <Widget>[
                      ...
                      //   thumbRadiusSpeed: ThumbRadiusSpeed.slow,
                      ...
                      SizedBox(
                          ...
                          child: LinearProgressIndicator(
                            backgroundColor:
                                HexColor(MyColors.gray).withOpacity(.5),
                            color: HexColor(MyColors.Orange_primary),
                            value:
                                double.parse(data_project.donationNeeded.replaceAll(',', '')) /
                                    double.parse("${data_project.budget}"),
                          )),
